...
export const CREATE_POLTERGEIST_CREATE_URL = "https://api.sariska.io/api/v1/media/poltergeist/create";
export const CREATE_POLTERGEIST_UPDATE_URL = "https://api.sariska.io/api/v1/media/poltergeist/update";
